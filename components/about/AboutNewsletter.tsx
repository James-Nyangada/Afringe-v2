    ...
    <section className="relative w-full bg-titanium py-32">
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <p className="mx-auto mb-16 max-w-2xl text-lg leading-relaxed text-midnight/70">
          At Afringe IT Solutions we are dedicated to delivering innovative technology solutions that address the unique needs of businesses like yours.
        </p>
        ...
        >
          <input
            ...
            required
          />
          <MagneticButton className="shrink-0 px-8 py-4">
            Subscribe
          </MagneticButton>
        </form>
      </div>
